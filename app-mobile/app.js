...
const VARIANTS_BY_ID = {
  ...
  XRAY: ["NORMAL", "GOLD", "CHEATMASTER", "LOOTHACKER", "BOUNTYHUNTER"],
  CRASHBANDICOOT: [
    "NORMAL",
    "GOLD",
    "CHEATMASTER",
